...
############################################################################################
snp=vector()
snp=samplegenomes(nsnp=2,ngene=1,npathway=1)
...
for(k in 1:3){
    maternal_genotype[[k]]=as.matrix(geno_list[[k]][mather_index, c(snp[1],snp[2])])
    for(q in 1:1000){
...
write.table(disease_genomat_finalfinal,"/Users/Shelly/Documents/Project_R_code/MATERNAL/disease_geno211.ped",
            quote=F,col.names = T,row.names = T)



disease.data=read.table("/Users/Shelly/Documents/Project_R_code/MATERNAL/disease_geno211.ped",header = T)
...
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/diseaseparents_e=0_211.csv")
dad.index=vector()
mom.index=vector()
...
#[1] 0.04444444
#[1] 0.07777778
#[1] 0.1861111 this is the probabilities when environment=0;situation is 2 snps,1 genes, 1pathway.
...
therow=sort(c(row1,row2))
thedata=disease.data[therow,]
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/diseaseparents_e=1_211.csv")
dad.index=vector()
mom.index=vector()
dad.index=seq(1,length(en.index),2)
mom.index=dad.index+1
...
#[1] 0.0171875
#[1] 0.075
#[1] 0.06875 this is the probability when environment=1, 2snp 1gene 1pathway.
