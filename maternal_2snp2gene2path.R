...
snp=vector()
snp=samplegenomes(nsnp=2,ngene=2,npathway=2) 
...
write.table(disease_genomat_finalfinal,"/Users/Shelly/Documents/Project_R_code/MATERNAL/2snp2gene2path/disease_geno222.ped",
            quote=F,col.names = T,row.names = T)



disease.data=read.table("/Users/Shelly/Documents/Project_R_code/MATERNAL/2snp2gene2path/disease_geno222.ped",header = T)
...
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/2snp2gene2path/diseaseparents_e=0_222.csv")
dad.index=vector()
mom.index=vector()
...
#[1] 0.05785124
#[1] 0.06887052
#[1] 0.1184573 this is the probabilities when environment=0;situation is 2 snps,2 genes, 2pathway.
...
therow=sort(c(row1,row2))
thedata=disease.data[therow,]
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/2snp2gene2path/diseaseparents_e=1_222.csv")
dad.index=vector()
mom.index=vector()
dad.index=seq(1,length(en.index),2)
mom.index=dad.index+1
...
#[1] 0.0188383
#[1] 0.0989011
#[1] 0.03296703 this is the probability when environment=1, 2snp 2genes 2pathway.
