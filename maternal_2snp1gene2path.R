...
snp=vector()
snp=samplegenomes(nsnp=2,ngene=1,npathway=2) 
...
write.table(disease_genomat_finalfinal,"/Users/Shelly/Documents/Project_R_code/MATERNAL/2snp1gene2path/disease_geno212.ped",
            quote=F,col.names = T,row.names = T)



disease.data=read.table("/Users/Shelly/Documents/Project_R_code/MATERNAL/2snp1gene2path/disease_geno212.ped",header = T)
...
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/2snp1gene2path/diseaseparents_e=0_212.csv")
dad.index=vector()
mom.index=vector()
...
#[1] 0.04109589
#[1] 0.1753425
#[1] 0.1534247 this is the probabilities when environment=0;situation is 1 snps,2 genes, 2pathway.
...
therow=sort(c(row1,row2))
thedata=disease.data[therow,]
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/2snp1gene2path/diseaseparents_e=1_212.csv")
dad.index=vector()
mom.index=vector()
dad.index=seq(1,length(en.index),2)
mom.index=dad.index+1
...
#[1] 0.01574803
#[1] 0.06456693
#[1] 0.1307087 this is the probability when environment=1, 1snp 1genes 2pathway.
