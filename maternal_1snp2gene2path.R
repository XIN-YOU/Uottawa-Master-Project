...
snp=vector()
snp=samplegenomes(nsnp=1,ngene=2,npathway=2) 
...
write.table(disease_genomat_finalfinal,"/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp2gene2path/disease_geno122.ped",
            quote=F,col.names = T,row.names = T)



disease.data=read.table("/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp2gene2path/disease_geno122.ped",header = T)
...
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp2gene2path/diseaseparents_e=0_122.csv")
dad.index=vector()
mom.index=vector()
...
#[1] 0.03835616
#[1] 0.2410959
#[1] 0.1068493 this is the probabilities when environment=0;situation is 1 snps,2 genes, 2pathway.
...
therow=sort(c(row1,row2))
thedata=disease.data[therow,]
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp2gene2path/diseaseparents_e=1_122.csv")
dad.index=vector()
mom.index=vector()
dad.index=seq(1,length(en.index),2)
mom.index=dad.index+1
...
#[1] 0.04251969
#[1] 0.0976378
#[1] 0.04094488 this is the probability when environment=1, 1snp 1genes 2pathway.
