...
snp=vector()
snp=samplegenomes(nsnp=1,ngene=2,npathway=1) 
...
write.table(disease_genomat_finalfinal,"/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp2gene1path/disease_geno121.ped",
            quote=F,col.names = T,row.names = T)



disease.data=read.table("/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp2gene1path/disease_geno121.ped",header = T)
...
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp2gene1path/diseaseparents_e=0_121.csv")
dad.index=vector()
mom.index=vector()
...
#[1] 0.03305785
#[1] 0.07438017
#[1] 0.1515152 this is the probabilities when environment=0;situation is 1 snps,2 genes, 1pathway.
...
therow=sort(c(row1,row2))
thedata=disease.data[therow,]
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp2gene1path/diseaseparents_e=1_121.csv")
dad.index=vector()
mom.index=vector()
dad.index=seq(1,length(en.index),2)
mom.index=dad.index+1
...
#[1] 0.0188383
#[1] 0.06279435
#[1] 0.1051805 this is the probability when environment=1, 1snp 2genes 1pathway.
