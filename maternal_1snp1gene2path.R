...
snp=vector()
snp=samplegenomes(nsnp=1,ngene=1,npathway=2) 
...
write.table(disease_genomat_finalfinal,"/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp1gene2path/disease_geno112.ped",
            quote=F,col.names = T,row.names = T)



disease.data=read.table("/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp1gene2path/disease_geno112.ped",header = T)
...
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp1gene2path/diseaseparents_e=0_112.csv")
dad.index=vector()
mom.index=vector()
...
#[1] 0.09375
#[1] 0.07954545
#[1] 0.1789773 this is the probabilities when environment=0;situation is 1 snps,1 genes, 2pathway.
...
therow=sort(c(row1,row2))
thedata=disease.data[therow,]
write.csv(thedata,"/Users/Shelly/Documents/Project_R_code/MATERNAL/1snp1gene2path/diseaseparents_e=1_112.csv")
dad.index=vector()
mom.index=vector()
dad.index=seq(1,length(en.index),2)
mom.index=dad.index+1
...
#[1] 0.01851852
#[1] 0.06481481
#[1] 0.03240741 this is the probability when environment=1, 1snp 1genes 2pathway.
